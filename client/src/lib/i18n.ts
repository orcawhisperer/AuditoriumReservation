...
const enTranslations = {
  ...
  admin: {
    ...
    manageReservationsDescription: "View and manage reservations for all shows",
    addShow: "Add Show",
    editShow: "Edit Show",
    ...
    reservationDetailsDescription: "Detailed information about the reservation",
    seatNumber: "Seat Number",
    currentSeat: "Current Seat",
    seatLayout: "Seat Layout",
    selectNewSeatDescription: "Select a new seat for this reservation",
    viewDetails: "View Details",
    deleteReservationWarning: "Are you sure you want to delete the reservation for ",
    deleteReservationWarningDetail: " This action cannot be undone.",
    deleting: "Deleting...",
    saving: "Saving...",
    reservationUpdated: "Reservation Updated",
    reservationUpdatedDescription: "The reservation has been successfully updated",
    ...
    selectDifferentSeats: "Select different seats to make changes",
    totalSeats: "Total Seats",
    createShow: "Create Show",
    blockSeats: "Block Seats",
    shows: "Shows",
    users: "Users",
...
const hiTranslations = {
  ...
  admin: {
    ...
    manageReservationsDescription: "सभी शो के लिए आरक्षण देखें और प्रबंधित करें",
    addShow: "शो जोड़ें",
    ...
    reservationDetailsDescription: "आरक्षण के बारे में विस्तृत जानकारी",
    seatNumber: "सीट नंबर",
    currentSeat: "वर्तमान सीट",
    seatLayout: "सीट लेआउट",
    selectNewSeatDescription: "इस आरक्षण के लिए एक नई सीट चुनें",
    viewDetails: "विवरण देखें",
    deleteReservationWarning: "क्या आप वाकई इस आरक्षण को हटाना चाहते हैं? ",
    deleteReservationWarningDetail: " यह क्रिया वापस नहीं की जा सकती।",
    deleting: "हटाया जा रहा है...",
    saving: "सहेजा जा रहा है...",
    reservationUpdated: "आरक्षण अपडेट किया गया",
    reservationUpdatedDescription: "आरक्षण सफलतापूर्वक अपडेट किया गया है",
    failedToUpdateReservation: "आरक्षण अपडेट करने में विफल",
    noSeatsSelected: "कोई सीट नहीं चुनी गई",
    selectAtLeastOneSeat: "कृपया कम से कम एक सीट चुनें",
    noChanges: "कोई परिवर्तन नहीं",
    selectDifferentSeats: "परिवर्तन करने के लिए अलग सीटें चुनें",
    totalSeats: "कुल सीटें",
    createShow: "शो बनाएं",
    blockSeats: "सीटें ब्लॉक करें",
    shows: "शो",
    users: "उपयोगकर्ता",
    reservations: "आरक्षण",
    user: "उपयोगकर्ता",
